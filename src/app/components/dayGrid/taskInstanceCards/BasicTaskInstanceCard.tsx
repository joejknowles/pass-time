    ...
    return (
      <Box
        ...
        sx={{
          position: "absolute",
          top: `CALC(1px + ${
            (((start.hour - daytimeHours[0]) * 60 + start.minute) /
          ...
          right: 16,
          backgroundColor: isThisTaskDetailsOpen
            ? "rgba(4, 70, 190, 0.9)"
            : "rgba(53, 61, 209, 0.68)",
          borderRadius: "4px",
          padding: duration === 15 ? "1px 4px" : "4px",
          boxSizing: "border-box",
          boxShadow: isThisTaskDetailsOpen
            ? "2px 2px 10px 1px rgba(123, 158, 206, 0.9)"
            : "",
          userSelect: "none",
        ...
        id={
          taskId
            ? `task-instance-calendar-card-${taskId}`
